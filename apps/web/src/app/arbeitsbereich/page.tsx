...
/**
 * Client-mount gate. The workspace body reads wallet + on-chain state through
...
export default function ArbeitsbereichPage() {
  ...
  return <ArbeitsbereichContent />;
}

function ArbeitsbereichContent() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <header>
        <h1 className="text-2xl font-semibold text-foreground">Arbeitsbereich</h1>
