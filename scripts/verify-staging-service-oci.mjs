...
const SECRET_ENV = /^(?:MECKY_INFERENCE_API_KEY|HETZNER_INFERENCE_API_KEY|NODE_AGENT_SECRET|CASE_STEWARD_TOKEN|CITIZEN_RELAY_ADMISSION_TOKEN|RELAY_ADMISSION_TOKEN|SYNTHETIC_CITIZENS_JSON)=/u;
const COMPONENTS = {
