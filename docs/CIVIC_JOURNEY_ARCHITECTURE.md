...
| [ADR 0023](adr/0023-city-neutral-citizen-eligibility-and-suggestion-adoption.md)      | proposed boundary; implementation pending | Verify municipality-specific eligibility behind a city-neutral public receipt, then let an eligible citizen adopt an immutable participant suggestion without gaining Case, voting, or treasury authority. |
