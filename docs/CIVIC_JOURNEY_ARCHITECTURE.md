...
| 3. Real Mecky loop                   | The user tags Mecky and receives one evidence-bound signed reply in the same thread                                                                | signed source-bound direct mentions can now enter retrieval only as attributed community statements; reviewed Civic Case retrieval and citation enforcement exist; local-news/RIS projection adapters, deployment, and browser E2E remain                         |
